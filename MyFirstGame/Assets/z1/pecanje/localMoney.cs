...
public class localMoney : MonoBehaviour
{
    ...
    public void updateLocalCoins()
    {
        ...
        brMetakaText.GetComponent<Text>().text = "" + pucajRibu.brojMetaka;
        brUhvacenihRibica.GetComponent<Text>().text = ""+ CameraMove.brojZakacenihRibica +"|"+CameraMove.brojMaxZakacenihRibica;
    }
}

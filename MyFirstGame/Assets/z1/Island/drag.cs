...
public class drag : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(transform.position.x <(cursorPos.x + 0.18f) && transform.position.x>(cursorPos.x-0.18f) && transform.position.y < (cursorPos.y +0.18f)&& transform.position.y>(cursorPos.y - 0.18f))
        {
